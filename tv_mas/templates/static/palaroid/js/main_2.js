...
;(function(window) {
	...
	function showGrid() {
		...
		dynamics.animate(titleEl, { translateY: -winsize.height/2, opacity: 1 }, {
			type: dynamics.bezier,
		...
		dynamics.css({ translateY: 200, opacity: 0 });
		dynamics.animate({ translateY: 0, opacity: 1 }, {
			type: dynamics.bezier,
			points: [{"x":0,"y":0,"cp":[{"x":0.2,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.3,"y":1}]}],
			duration: 800,
			delay: 400
		...
		dynamics.css({ translateY: 150, opacity: 0 });
		dynamics.animate({ translateY: 0, opacity: 1 }, {
			type: dynamics.bezier,
			points: [{"x":0,"y":0,"cp":[{"x":0.2,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.3,"y":1}]}],
			duration: 800,
