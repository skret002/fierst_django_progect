...
BASE_URL_SONY = 'http://www.repair-tv-sony.ru/models'
atach_url_SONY = 'https://www.repair-tv-sony.ru'
ROOT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
BASE_DIR = os.path.join(ROOT_DIR, "templates","static", "media")
IMG_SONY = os.path.join(BASE_DIR, "img/",  "sony/")
BREND_SONY = "Sony"

def get_page_count_sony():
    response = requests.get(BASE_URL_SONY).text
